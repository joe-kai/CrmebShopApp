...
import com.joekay.module_home.databinding.LayoutCombinationItemBinding
 ...
 * @explain：
 */
class HomeCombinationAdapter @Inject constructor(
    ...
    inner class ViewHolder : BaseViewHolder(R.layout.layout_combination_item) {

        private val binding by lazy {
            LayoutCombinationItemBinding.bind(getItemView())
        }
