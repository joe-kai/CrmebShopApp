...
import com.joekay.base.dialog.MessageDialog
...
import com.joekay.module_video.ui.FullVideoFragment
    ...
    override fun initBinding() {
        MessageDialog.Builder(this)
            ...
            .setListener(object : MessageDialog.OnListener {
                override fun onConfirm(dialog: MessageDialog.Builder) {
                    switchFragment(this@VideoActivity, FullVideoFragment())
                }

                override fun onCancel(dialog: MessageDialog.Builder) {
                    switchFragment(this@VideoActivity, VideoFragment())
                }
            })
            .show()
