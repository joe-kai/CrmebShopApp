package com.joekay.lib_base.utils
        ...
        try {
            ...
            for (i in actualTypeArguments.indices) {
                ...
                if (ViewBinding::class.java.isAssignableFrom(tClass)) {
                   // val methods: Array<Method> = tClass.declaredMethods //获取class对象的所有声明方法
                   //
                   //for ( me in methods){
                   //    Log.e("----declaredMethods",me.name)
                   //}
                   // val allMethods: Array<Method> = tClass.methods
                   // for ( me in allMethods){
                   //     Log.e("----methods",me.name)
                   // }
                    val inflate = tClass.getDeclaredMethod("inflate", LayoutInflater::class.java)
