...
public class LinearDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private float listDividerSize = 10;
    ...
    private void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            float rectBottom = (i != childCount - 1) ? rectTop + listDividerSize : rectTop;
    ...
    private void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            float rectRight = (i != childCount - 1) ? rectLeft + listDividerSize : rectLeft;
            c.drawRect(rectLeft, rectTop, rectRight, rectBottom, mTextPaint);
        }
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (mOrientation == VERTICAL_LIST) {
            outRect.set(0, 0, 0, (itemPosition != childCount) ? (int) listDividerSize : 0);
        } else {
            outRect.set(0, 0, (itemPosition != childCount) ? (int) listDividerSize : 0, 0);
        }
    }
}
