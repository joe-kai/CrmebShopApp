...
class FullAutoPlayScrollListener(private val itemPlayId: Int) : RecyclerView.OnScrollListener() {
    ...
    override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
        ...
        println("-------onScrolled-> firstVisibleItem:$firstVisibleItem     lastVisibleItem:$lastVisibleItem")
        firstVisible = firstVisibleItem
        lastVisible = lastVisibleItem
        visibleCount = lastVisibleItem - firstVisibleItem
    }
